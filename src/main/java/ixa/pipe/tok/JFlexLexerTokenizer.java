...
/**
 *  JFlexLexerTokenizer is based on the {@link JFlexLexer} class. 
 *  This Tokenizer overrides {@link AbstractTokenizer} getToken() method 
 *  by using the {@link JFlexLexer} yylex() method.  
 *  
 ...
 * the @link PTBLexer class of Stanford CoreNLP version 3.2.0, but with changes for 
 * other normalization requirements, such as those of the Ancora corpus. 
 *  
...
public class JFlexLexerTokenizer<T> extends AbstractTokenizer<T> {

  
  private JFlexLexer jlexer;
   ...
   * 
   */
  public JFlexLexerTokenizer(BufferedReader breader, TokenFactory tokenFactory, String options) {
    jlexer = new JFlexLexer(breader, tokenFactory, options);
  }
